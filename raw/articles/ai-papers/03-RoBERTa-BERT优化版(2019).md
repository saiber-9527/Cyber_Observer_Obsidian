...
we consider RoBERTa trained for 500K steps over 3.2. 
...
|Model|SQuAD 1.1<br>EM<br>F1|SQuAD 1.1<br>EM<br>F1|SQuAD 2.0<br>EM<br>F1|SQuAD 2.0<br>EM<br>F1|Model<br>Single models|Accuracy<br>Middle<br>on test (as of July 25,|High<br>2019)|
|---|---|---|---|---|---|---|---|
|Single models|on dev,|w/o data augmentation|||BERTLARGE|72.0<br>76.6|70.1|
|BERTLARGE|84.1|90.9|79.0|81.8|XLNetLARGE|81.7<br>85.4|80.2|
|XLNetLARGE|89.0|94.5|86.1|88.8|RoBERTa|83.2<br>86.5|81.3|
|RoBERTa|88.9|94.6|86.5|89.4||||
|Single models<br>XLNetLARGE|on test|(as of|July 25,<br>86.3†|2019)<br>89.1†|Table 7: Results on<br>XLNetLARGE results|the RACE test set. BERTLARGE a<br>are fromYang et al.(2019).||
|RoBERTa|||86.8|89.8||||
|XLNet + SG-Net Verifer|||87.0†|89.9†||||
